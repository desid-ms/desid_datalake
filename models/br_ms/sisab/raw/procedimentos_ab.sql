MODEL (
    name raw.procedimentos_ab_sigtap,
    kind FULL
);
    
SELECT co_procedimento_ab, procedimento_ab, co_procedimento_sigtap, procedimento_sigtap FROM (
    VALUES
    ('ABPG007', 'Curativo especial', '0301100276', 'Curativo especial'),
    ('ABPG027', 'Administração de medicamentos via Oral', '0301100217', 'Administração de m
    edicamentos por via oral'),
    ...
    ('ABPO015', 'Orientação de Higiene Bucal', '0101020104', 'Orientação de higiene buca')) 
